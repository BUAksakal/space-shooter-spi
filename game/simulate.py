...
p1_score  = 0
p2_score  = 0
game_state = "menu"        # "menu", "waiting", "countdown", "playing", "game_over"
winner     = None
...
def main():
    ...
    while running:
        ...
        # ── PLAYING ───────────────────────────────────────────────────
            ...
            # -- Module 5 (simulated Pi B): read P2 keys, push SPI packet --
            p2_jx  = _axis_from_key(pygame.K_LEFT,  pygame.K_RIGHT)
            p2_jy  = _axis_from_key(pygame.K_UP,    pygame.K_DOWN)
            p2_btn = 1 if p2_shot_this_frame else 0
            ...
            # -- P1 keyboard (mock joystick ADC) --
            p1_dx = _normalize_key_axis(pygame.K_a, pygame.K_d)
            p1_dy = _normalize_key_axis(pygame.K_w, pygame.K_s)
